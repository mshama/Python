...
urlpatterns = [
    ...
    url(r'^deleteInstrument/(?P<instrument_id>[0-9]+)/$', views.deleteInstrument, name='deleteInstrument'),
    ...
    url(r'^searchInstruments/$', views.searchInstruments, name='searchInstruments'),
