...
class Instrument(models.Model):
    ...
    isin_c = models.CharField(db_column='ISIN_C', max_length=100)
...
class Riskfactor(models.Model):
    ...
    riskfactorcomposition = models.ForeignKey('Riskfactorcomposition', models.DO_NOTHING, db_column='RiskfactorComposition_ID', related_name='+')  # Field name made lowercase.
...
class Riskfactorcomposition(models.Model):
    id = models.IntegerField(db_column='ID', primary_key=True)  # Field name made lowercase.
    riskfactor = models.ForeignKey(Riskfactor, models.DO_NOTHING, db_column='Riskfactor_ID', related_name='+')  # Field name made lowercase.
